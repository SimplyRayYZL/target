    ...
    >
      ...
      <div className="flex flex-col flex-grow space-y-1.5">
        ...
        <div className="flex flex-col gap-2 mt-auto pt-3">
          ...
          >
            <Button
              className="w-full bg-green-500 hover:bg-green-600 text-white border-green-500 hover:border-green-600 h-10 gap-2 text-sm font-semibold"
            >
          ...
          <Button
            ...
            className="w-full bg-secondary hover:bg-accent text-secondary-foreground gap-2 transition-all duration-300 hover:scale-[1.02] h-10 text-sm font-semibold"
          >
